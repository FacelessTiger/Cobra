...
namespace Cobra {
	...
	void Cobra::Renderer2D::DrawCircle(const glm::mat4& transform, const glm::vec4& color, float thickness, float fade, int entityID)
	{
		CB_PROFILE_FUNCTION();
	...
	void Cobra::Renderer2D::DrawRect(const glm::mat4& transform, const glm::vec4& color, int entityID)
	{
	...
	float Cobra::Renderer2D::GetLineWidth()
	{
		return s_Data.LineWidth;
	}

	void Cobra::Renderer2D::SetLineWidth(float width)
	{
