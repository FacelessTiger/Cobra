...
namespace Ellis {
	...
	void Ellis::Renderer2D::DrawCircle(const glm::mat4& transform, const glm::vec4& color, float thickness, float fade, int entityID)
	{
		EL_PROFILE_FUNCTION();
	...
	void Ellis::Renderer2D::DrawRect(const glm::mat4& transform, const glm::vec4& color, int entityID)
	{
	...
	void Ellis::Renderer2D::SetLineWidth(float width)
	{
